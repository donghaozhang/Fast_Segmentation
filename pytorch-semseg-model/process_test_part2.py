...
for pic_num in range(1, 2):
#     counter = counter + 1
    program_name = 'python'
    test_script_path = ' test.py'
    model_args = ' --model_path'
    linknet_model_path = ' linknet_cellcancer_1_300.pkl'
    ...
    counet_label_img_save_path = '/home/neuron/Desktop/Donghao/cellsegmentation/neural_network_learn/lib/pytorch-CycleGAN-and-pix2pix-master/results/multitask_v2/test_latest' \
    ...
    # # # fig = plt.figure()
    # # # plt.imshow(cur_img_ganunet_label)
    # # # plt.title("cur_img_ganunet_label")
    # #
